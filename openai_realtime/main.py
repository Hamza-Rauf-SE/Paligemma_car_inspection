...
INSTRUCTIONS = f"""
be my helpful assistant and reply to my messages. avoid repeating yourself and echo back my messages. wait for my question to ask and then reply.
"""
...
class RealtimeClient:
    ...
    def __init__(self, instructions, voice="alloy"):
        ...
        self.current_text_response = ''  # Store text response for logging
        ...
        self.VAD_config = {
            "type": "server_vad",
            "threshold": 0.6,  # Activation threshold (0.0-1.0). A higher threshold will require louder audio to activate the model.
        ...
        self.session_config = {
            ...
            # "output_text": True,  # Ensure text output is enabled alongside audio
    ...
    async def connect(self):
        ...
        # Update for websockets v14.0+
        self.ws = await websockets.connect(
            f"{self.url}?model={self.model}",
            ssl=self.ssl_context,
            additional_headers=headers  # Use additional_headers for websockets v14.0+
        )
    ...
    async def handle_event(self, event):
        ...
        if event_type == "error":
            ...
            # Print text response incrementally with better formatting
            text_delta = event["delta"]
            
            # Start a new line for response if this is the first delta
            ...
            # Reset for next response and add a visual separator
    ...
    async def send_text(self, text):
        ...
        """
        # Print user message with clear formatting
        print(f"\nYou: {text}")
        print("-" * 50)
    ...
    async def run(self):
        ...
        try:
            print("\n" + "-" * 50)
            print("OpenAI Realtime Assistant started")
            print("-" * 50)
...
async def main():
    ...
    try:
        ...
        logger.info("Exiting OpenAI Realtime Assistant")
